...
public class OrderDaoImpl implements OrderDao {
    ...
    private static final String FIND_USER_ORDERS_SQL = FIND_ALL_SQL + " WHERE u.id = ?";
    ...
    public List<Order> findUserOrdersById(Long id) {
        try (Connection connection = ConnectionManager.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_USER_ORDERS_SQL)) {
            preparedStatement.setLong(1, id);
            ResultSet resultSet = preparedStatement.executeQuery();
